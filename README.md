...
אופן המימוש - **gameIsEnding** פונקציה שנמצאת במחלקה catan, מקבלת player ובודקת האם הוא הגיע ל-10 נקודות וניצח. 
במידה וכן מדפיסה לו הודעה מזל טוב על ניצחונו המטרה שרק שחקן בתורו ינצח.
